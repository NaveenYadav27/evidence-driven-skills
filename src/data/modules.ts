...
export const MODULES: CEHModule[] = [
  ...
  { id: "m02", number: 2, slug: "footprinting-and-reconnaissance", title: "Footprinting and Reconnaissance", short: "Passive & active intel gathering on real targets.", domain: "Reconnaissance", status: "available", labCount: 14, challengeCount: 5, tools: ["whois", "dig", "nslookup", "theHarvester", "Sublist3r"] },
