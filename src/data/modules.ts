...
export const MODULES: CEHModule[] = [
  ...
  { id: "m13", number: 13, slug: "hacking-web-servers", title: "Hacking Web Servers", short: "Header audits, robots.txt intel, stack fingerprinting.", domain: "Web", status: "available", labCount: 3, challengeCount: 1, tools: ["headers", "robots", "wayback"] },
